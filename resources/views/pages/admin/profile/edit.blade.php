            ...
            <form action="/dashboard/profile" method="POST">
                ...
                <div class="col-md-12 col-xs-12">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="name" name="name" value="{{ $datauser->name, old('name') }}"
                            required>
                        @error('name')
                    ...
                    <div class="mb-3">
                        ...
                        <input type="email" class="form-control" id="email" name="email" value="{{ $datauser->email, old('email') }}"
                            required>
                        @error('email')
                            <small class="text-danger">{{ $message }}</small>
                        @enderror
